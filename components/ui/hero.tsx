...
// NOTE: These are stable Unsplash image URLs (stock photos).
const UNSPLASH_AVATAR_1 =
  "https://images.unsplash.com/photo-1524504388940-b1c1722653e1?auto=format&fit=crop&w=256&h=256&q=80";
const UNSPLASH_AVATAR_2 =
    ...
    <div className="min-h-screen bg-[#0038FF] flex flex-col font-sans selection:bg-[#CCFF00] selection:text-black relative overflow-hidden w-full">
      ...
      <nav className="relative z-20 flex items-center justify-between px-6 py-6 md:px-10 md:py-8 max-w-[1440px] mx-auto w-full">
        ...
        <div className="hidden md:flex items-center space-x-2">
          {["How it works", "Roast mode", "Share cards", "No login"].map((item) => (
            <a
              key={item}
              href="#"
